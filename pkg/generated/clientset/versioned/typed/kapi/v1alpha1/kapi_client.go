...
func (c *SamplecontrollerV1alpha1Client) LRPs(namespace string) LRPInterface {
	return newLRPs(c, namespace)
}

func (c *SamplecontrollerV1alpha1Client) Stagings(namespace string) StagingInterface {
