	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KapiV1alpha1().LRPs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KapiV1alpha1().LRPs(namespace).Watch(options)
			},
		},
		&kapicforgv1alpha1.LRP{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *lRPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kapicforgv1alpha1.LRP{}, f.defaultInformer)
}
