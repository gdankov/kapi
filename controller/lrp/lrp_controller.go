...
const controllerAgentName = "lrp-controller"

type LRPController struct {
	kapiClientset clientset.Interface

	lrpsLister listers.LRPLister
...
func NewController(
	kapiclientset clientset.Interface,
	lrpInformer informers.LRPInformer) *LRPController {
...
func (c *LRPController) enqueueFoo(obj interface{}) {
	var key string
	var err error
